...
public class AuthorMapperTest {
	 ...
	 * 
	 * Criteria cri = new Criteria(3,10); // 3페이지 & 10개 행 표시 cri.setKeyword("김난도");
	 * 
	 ...
	 * 
	 * Criteria cri = new Criteria(); cri.setKeyword("김난도");
	 * 
	 ...
	 * mapper.authorGetDetail(authorId)); }
	 */
